...
public:
    ...
    virtual void doexec( innerclass * pinnerclass)=0;

};

class innerderiv : public innerclass {

public:
    innerderiv(int *dervinpAddr, int dervsNum):innerclass(dervinpAddr,dervsNum){};
    void doexec( innerclass * pinnerclass) {
            std::cout << "RAVIIIIIII: xhaahjhja:" << __LINE__ <<std::endl;
        };
};
...
public:
    ...
    innerderiv *classarray[ARRAYSIZE];
